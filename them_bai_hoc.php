...
<body>
    ...
    <div class="container">
        ...
        <form action="xuly_them_bai_hoc.php" method="POST" enctype="multipart/form-data">
            <div class="form-group">
                <label for="lesson_name">
                    <i class="fa fa-book" aria-hidden="true"></i>
                    Tên bài học
                </label>
                <input type="text" id="lesson_name" name="lesson_name" required placeholder="Nhập tên bài học">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description" required
                    placeholder="Nhập mô tả ngắn về bài học"></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="content" name="content" required placeholder="Nhập nội dung chi tiết của bài học"
            ...
            <div class="form-group">
                ...
                <input type="number" id="duration" name="duration" required placeholder="Nhập thời lượng bằng phút"
                    min="1">
            </div>
