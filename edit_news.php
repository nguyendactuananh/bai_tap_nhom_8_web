...
<head>
    ...
    <title>Sửa bài học - <?php echo $title; ?></title>
    ...
    <div class="container">
        ...
        <form action="update_news.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" id="subtitle" name="subtitle" required value="<?php echo $subtitle; ?>">
            </div>
            <div class="form-group">
                <label for="content">
            ...
            <div class="form-group">
                ...
                <input type="text" id="author" name="author" required value="<?php echo $author; ?>">
            </div>
            <div class="form-group">
                <label for="image">
                ...
                <i style="color: #666; font-size: 14px;">Để trống nếu không muốn thay đổi ảnh</i>
                <?php if (!empty($image)): ?>
                <div class="current-image">
                    <p style="color: #666; font-size: 14px; margin: 10px 0 5px 0;">Ảnh hiện tại:</p>
                    <img src="<?php echo $image; ?>" alt="Ảnh bài học hiện tại">
                </div>
                <?php endif; ?>
            </div>
